        ...
        <div style="display: flex; flex-direction: row;">
            ...
            <div v-if="isNew" style="width: 25%">
                <div style="border: 1px solid black; border-radius: 5px; padding: 10px 10px 10px 10px">
                    <input type="text" class="form-input" placeholder="Department Name" v-model="form.name"><br><br>

                    <input type="text" class="form-input" placeholder="Contact #" v-model="form.contact"><br><br>

                    <select class="form-input" v-model="form.user_id">
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            let url = 'http://localhost:8080/api/departments/create'

            if(!!this.form.id) {
                url = 'http://localhost:8080/api/departments/update'
            }
        ...
        update() {
            this.form = {
                ...
                user_id: this.selectedItems[0].user_id,
            }
        ...
        detele(){
            ...
            axios.post('http://localhost:8080/api/departments/delete', {ids: ids}, header)
                .then(function (response) {
                    location.reload()
                })
                .catch(function (error) {
        ...
        sendMessage(){
          let header = this.$store.getters.headerReq
            ...
            axios.post('http://localhost:8080/api/departments/send-sms', {contacts: contacts, message: this.sms}, header)
                .then(function (response) {
                    location.reload()
                })
                .catch(function (error) {
